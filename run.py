...
def validate_data(values):
    '''
    Inside the try, coverts all strings into integers.
...
# These functions got refractored into update_worksheet
# --------------------------------------------------------------
# def update_sales_worksheet(data):
#     """
#     Updates sales worksheet, add new row with data provided.
#     """
...
#     """
#     Updates surplus worksheet, add new row with data provided.
#     """
...
def get_stock_values(data):
    ...
    for heading, data in zip(headings, data):
        stock_dictionary.update({heading: data})
